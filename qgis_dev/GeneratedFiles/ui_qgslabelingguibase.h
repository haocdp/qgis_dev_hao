...
public:
    ...
    void setupUi(QWidget *QgsLabelingGuiBase)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 580, 406));
...
"font-style: italic;"));
        ...
        scrollAreaWidgetContents_6->setGeometry(QRect(0, 0, 330, 311));
        ...
        scrollAreaWidgetContents_3->setGeometry(QRect(0, 0, 298, 208));
        ...
        scrollAreaWidgetContents_2->setGeometry(QRect(0, 0, 370, 566));
        ...
        scrollAreaWidgetContents_8->setGeometry(QRect(0, 0, 304, 348));
        ...
        scrollAreaWidgetContents_4->setGeometry(QRect(0, 0, 340, 689));
        ...
        scrollAreaWidgetContents_5->setGeometry(QRect(0, 0, 401, 510));
        ...
        QWidget::setTabOrder(chkEnableLabeling, btnEngineSettings);
        QWidget::setTabOrder(btnEngineSettings, scrollArea_mPreview);
        QWidget::setTabOrder(scrollArea_mPreview, groupBox_mPreview);
        QWidget::setTabOrder(groupBox_mPreview, mPreviewTextEdit);
        ...
        QWidget::setTabOrder(radLineHorizontal, radPolygonPerimeter);
        QWidget::setTabOrder(radPolygonPerimeter, radOverCentroid);
        QWidget::setTabOrder(radOverCentroid, radAroundPoint);
        QWidget::setTabOrder(radAroundPoint, radPolygonFree);
        QWidget::setTabOrder(radPolygonFree, radAroundCentroid);
        QWidget::setTabOrder(radAroundCentroid, radPolygonHorizontal);
        QWidget::setTabOrder(radPolygonHorizontal, chkLineAbove);
        ...
        QWidget::setTabOrder(mCentroidInsideCheckBox, mPointOffsetAboveLeft);
        QWidget::setTabOrder(mPointOffsetAboveLeft, mPointOffsetAbove);
        QWidget::setTabOrder(mPointOffsetAbove, mPointOffsetAboveRight);
        QWidget::setTabOrder(mPointOffsetAboveRight, mPointQuadOffsetDDBtn);
        QWidget::setTabOrder(mPointQuadOffsetDDBtn, mPointOffsetLeft);
        ...
        QWidget::setTabOrder(mPointOffsetBelowRight, mPointOffsetXSpinBox);
        ...
        QWidget::setTabOrder(mPointOffsetUnitsDDBtn, mLineDistanceSpnBx);
        QWidget::setTabOrder(mLineDistanceSpnBx, mLineDistanceDDBtn);
        QWidget::setTabOrder(mLineDistanceDDBtn, mLineDistanceUnitDDBtn);
        QWidget::setTabOrder(mLineDistanceUnitDDBtn, mPointAngleSpinBox);
        ...
        QWidget::setTabOrder(mMaxCharAngleDDBtn, mPlacementDDGroupBox);
        QWidget::setTabOrder(mPlacementDDGroupBox, mCoordXDDBtn);
        ...
        QWidget::setTabOrder(chkPreserveRotation, mPriorityGrpBx);
        QWidget::setTabOrder(mPriorityGrpBx, mPrioritySlider);
        QWidget::setTabOrder(mPrioritySlider, radOverPoint);
        QWidget::setTabOrder(radOverPoint, scrollArea_4);
        ...
        QWidget::setTabOrder(mFontMaxPixelDDBtn, mPalShowAllLabelsForLayerChkBx);
        ...
        QWidget::setTabOrder(mUpsidedownRadioAll, mRenderingFeaturesGrpBx);
        QWidget::setTabOrder(mRenderingFeaturesGrpBx, chkLabelPerFeaturePart);
        ...
        QWidget::setTabOrder(mMinSizeSpinBox, chkNoObstacle);
        QWidget::setTabOrder(chkNoObstacle, mRenderingLabelGrpBx);
